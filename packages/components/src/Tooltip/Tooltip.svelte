<script>
  ...
  import { TooltipVariant, TooltipPosition, TooltipTrigger } from "./constants";
  ...
  $: props = {
    ...
    class: spreadClassnames([
      ...
      variant &&
        ...
        `gbs-tooltip--${variant}`,
      position && `gbs-tooltip--${position}`,
      icon && variant !== TooltipVariant.AVATAR && "gbs-tooltip--icon",
    ]),
  };
...
<style>
  ...
  .gbs-tooltip--bottom,
  .gbs-tooltip--bottom-start,
  .gbs-tooltip--bottom-end {
    top: 100%;
  }

  .gbs-tooltip--top,
  .gbs-tooltip--top-start,
  .gbs-tooltip--top-end {
    bottom: 100%;
  }
  ...
  .gbs-tooltip :global(.tooltip-icon) {
